...
const int NOMBRE=10; //MAXIMA CANTIDAD DE CARACTERES PARA LOS NOMBRES DE LOS CANARIOS

typedef char TCadena[NOMBRE]; 
...
//Función que nos permite saber a que periquito toca dar vitaminas conociendo la fecha de adopción y la fecha
void darVitaminas(TCanarios pajaros, int canarios)  {
